...
struct Conn {
    int fd = -1 ;
    uint32_t state = 0 ; // eithjer STATE_REQ or STATE_RES
    // buffer for reading
    size_t rbuf_size = 0 ;
...
// the data structure for the key spacem. this is just a placeholder
// until we implement a hashtable in the next push
